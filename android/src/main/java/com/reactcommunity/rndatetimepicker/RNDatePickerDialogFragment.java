...
public class RNDatePickerDialogFragment extends DialogFragment {
    ...
    DatePickerDialog getDialog(
        ...
        if (args != null && args.getString(RNConstants.ARG_DISPLAY, null) != null) {
            String locale_string = args.getString(RNConstants.LOCALE);
            Locale locale;
            if (locale_string == null) {
                locale = Locale.getDefault();
             } else {
                locale = new Locale(locale_string,locale_string.toUpperCase());
            }
            Locale.setDefault(locale);

            display = RNDatePickerDisplay.valueOf(args.getString(RNConstants.ARG_DISPLAY).toUpperCase(locale));
        }
